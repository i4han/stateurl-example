/**
 * TransitionsMedium - Medium transition page
 *
 * path: 'transitions-medium' → TransitionsMedium component, TransitionsMediumRoute
 */

import { defineRoute, useSignals, handleHref } from 'stateurl'

const transitionsMediumConfig = {
    path: 'medium',
    trail: '/transitions-demo',
    label: 'transitionsMedium',
} as const

export const TransitionsMediumRoute = defineRoute(TransitionsMedium, transitionsMediumConfig)

export default function TransitionsMedium() {
    useSignals()
    return (
        <section>
            <h2>Medium Page</h2>
